...
Выберите действие:
    ...
    async def button_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        logger.info("=== BUTTON CALLBACK STARTED ===")
        ...
        logger.info("=== BUTTON CALLBACK COMPLETED ===")
