#!/usr/bin/env python3
"""
Тестовый скрипт для создания тестового вклада
"""
...
def create_test_deposit():
    """Создать тестовый вклад для демонстрации системы"""
    ...
    with sqlite3.connect(DATABASE_PATH) as conn:
        ...
        print(f"💰 Создаем тестовый вклад для пользователя {user_id}: {amount} USDT")
