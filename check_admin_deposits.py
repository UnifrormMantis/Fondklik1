#!/usr/bin/env python3
"""
Скрипт для проверки депозитов админа
"""
...
def check_admin_deposits():
    """Проверить депозиты админа"""
    
    admin_id = 798427688  # ID админа
    
    print(f"🔍 Проверяем депозиты админа {admin_id}")
